...
const offer = getOfferBySlug('abonnement-iptv-1-mois')!;
...
export default function Abonnement1MoisPage() {
  ...
  return (
    <>
      ...
      {/* FAQ */}
      <FAQSection faqs={productFAQ} title="Questions fréquentes sur l'abonnement 1 mois" />
      ...
      <section className="border-t border-border py-12">
        <div className="mx-auto max-w-2xl px-4 text-center sm:px-6">
          ...
          <p className="mb-6 text-sm text-muted">
            Paiement par Wave ou Orange Money. Activé en moins de 5 minutes.
          </p>
          <WhatsAppCTA
            offerName={offer.name}
            price={offer.priceLabel}
