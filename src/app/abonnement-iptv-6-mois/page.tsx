...
const offer = getOfferBySlug('abonnement-iptv-6-mois')!;
...
export default function Abonnement6MoisPage() {
    ...
    <>
      ...
      <section className="py-12 sm:py-16">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
          {offer.badge && (
            <span className="mb-4 inline-block rounded-full bg-jaune px-4 py-1.5 text-sm font-bold text-background">
              ⭐ {offer.badge}
            </span>
          )}
      ...
      {/* FAQ */}
      <FAQSection faqs={productFAQ} title="Questions fréquentes sur l'abonnement 6 mois" />
