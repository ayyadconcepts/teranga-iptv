...
const offer = getOfferBySlug('abonnement-iptv-3-mois')!;
...
export default function Abonnement3MoisPage() {
  ...
  return (
    <>
      ...
      {/* FAQ */}
      <FAQSection faqs={productFAQ} title="Questions fréquentes sur l'abonnement 3 mois" />
